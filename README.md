[![Build Status](https://github.com/gap-packages/GaloisGroups/workflows/CI/badge.svg?branch=master)](https://github.com/gap-packages/GaloisGroups/actions?query=workflow%3ACI+branch%3Amaster)
